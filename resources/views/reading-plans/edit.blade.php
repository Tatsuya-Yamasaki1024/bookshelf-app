                ...
                <div class="p-6 text-gray-900">
                    <div class="mb-4">
                        ...
                        <p class="text-sm text-gray-700">現在の状態:
                            <span
                                class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $readingPlan->status->badgeClass() }}">
                    ...
                    <form action="{{ route('reading-plans.update', $readingPlan) }}" method="POST" novalidate>
                        ...
                        @method('PUT')
                        <div class="mb-4">
                            <label for="target_date" class="block text-sm font-medium text-gray-700">期日 <span
