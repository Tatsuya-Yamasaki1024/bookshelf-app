...
class StoreBookRequestTest extends TestCase
{
    ...
    // 書籍登録時にisbnが未入力の場合はバリデーションエラーになる
    public function test_store_book_requires_isbn(): void
    {
        $genre = Genre::factory()->create();
    ...
    // 書籍登録時にpublished_dateが未入力の場合はバリデーションエラーになる
    public function test_store_book_requires_published_date(): void
    {
        $genre = Genre::factory()->create();
